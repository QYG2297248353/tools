...
import com.ms.tools.annotation.MethodRunTime;
...
public class MethodRunTimeAspect {
    ...
    public Object logTime(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        String format = StrFormatUtils.format("Thread {} Method {} run time: {} {}", Thread.currentThread().getName(), method.getName(), elapsedTimeValue, timeUnit);
        log.info(format);
        return result;
    }
}
