...
import com.ms.annotation.RequestLimit;
import com.ms.annotation.config.LimitAspectCondition;
import com.ms.annotation.manager.Limiter;
    ...
    public void before(JoinPoint joinPoint) {
        ...
        if (limit != null) {
            ...
            if (!limiterManager.tryAccess(limiter)) {
                throw new MsLimiterRunException("There are currently many people , please try again later!");
            }
        }
    }
}
