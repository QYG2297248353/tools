...
import com.ms.tools.core.id.factory.ksuid.Ksuid;
import com.ms.tools.core.id.factory.ksuid.KsuidCreator;
import com.ms.tools.core.id.factory.snowflake.SnowFlakeCreator;
import com.ms.tools.core.id.factory.tsid.Tsid;
import com.ms.tools.core.id.factory.tsid.TsidCreator;
import com.ms.tools.core.id.factory.ulid.Ulid;
import com.ms.tools.core.id.factory.ulid.UlidCreator;
import com.ms.tools.core.id.factory.uuid.UuidCreator;
...
public class ID {
    ...
    public static String shortUrl(String originalURL) {
        return ShortUrlUtils.generateShortURL(originalURL);
    }
    ...
    public static String shortUrl(String originalURL, int length) {
        return ShortUrlUtils.generateShortURL(originalURL, length);
    }
    ...
    public static String compress(String str) {
        return ShortUrlUtils.generateShortURL(str);
    }
    ...
    public static String compress(String str, int length) {
        return ShortUrlUtils.generateShortURL(str, length);
    }
}
