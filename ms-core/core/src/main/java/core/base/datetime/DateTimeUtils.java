...
package core.base.datetime;

import core.base.datetime.factory.DateTimeFactory;
import core.exception.base.MsToolsRuntimeException;
...
public class DateTimeUtils {
    ...
    public static LocalDateTime toLocalDateTime(Date date) {
        return DateTimeFactory.toLocalDateTime(date);
    }
    ...
    public static boolean isLeapYear(int year) {
        return DateTimeFactory.isLeapYear(year);
    }
    ...
    public static boolean compare(Date date1, Date date2) {
        ...
        return DateTimeFactory.compare(date1, date2);
    }
}
