...
public class MsRedisBeanFactoryPostProcessor implements BeanDefinitionRegistryPostProcessor {

    protected static final String BASE_PACKAGE = "com.ms.tools.redis";
